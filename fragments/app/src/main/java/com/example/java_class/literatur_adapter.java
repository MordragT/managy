...
public class literatur_adapter extends ArrayAdapter<schnitstelle.literatur_eintrag> { //<____________________________________________________________________________________________________________________
    ...
    public literatur_adapter(@NonNull Context context, int resource, ArrayList<schnitstelle.literatur_eintrag> objects) { // Ändern für jedes dokument
    ...
    public View getView(final int position, @Nullable View convertView, @NonNull final ViewGroup parent) {
        ...
        convertView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ((MainActivity)getContext()).getSupportFragmentManager().beginTransaction().replace(R.id.nav_host_fragment,new literatur_bearbeiten()).commit();
